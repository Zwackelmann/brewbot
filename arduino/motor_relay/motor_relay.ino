...
#define MOTOR_CMD_PGN    0xFFB0
#define MOTOR_STATE_PGN  0xFFB1
#define PRIORITY     6
...
// SG_ RELAY_STATE : 0|1@1+ (1,0) [0|1] "" MOTOR_NODE
...
void send_relay_status() {
  ...
  frame.can_id = Util::pgn_to_can_id(MOTOR_STATE_PGN, PRIORITY, NODE_ADDR, 0xFF);
